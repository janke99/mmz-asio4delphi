...
uses DXSock, classes, untASIOSvr;
...
type
  ...
  public
    ...
    function GetStream(IStream: TStream; IConn: TDXsock): integer;
...
function TSocketClient.GetStream(IStream: TStream;
  IConn: TDXsock): integer;
var
